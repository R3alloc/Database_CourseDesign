...
public class LocationDAOSQLImpl extends DAOBase implements LocationDAO {
	...
	private String loc_table_name="book_store_info";
	public boolean createLocation(Book_Location bk_loc)throws DAOException
	{
		String create_loc_sql="insert into "+loc_table_name+"(loc_callNo,loc_barcode,loc_voliss,loc_room,loc_status,loc_location,loc_borrTime,loc_dueTime) "
							+" values(?,?,?,?,?,?,?,?) ";
