...
public class UserDAOSQLImpl extends DAOBase implements UserDAO {
	...
	private static final String SEARCH_USER_SQL="select user_name,user_sex,start_date,end_date from user_table where user_id=";	
	@Override
	public User getUser(String userID) throws DAOException {
		// TODO Auto-generated method stub
		Connection conn = null;
		try {
			...
			ResultSet rs=state.executeQuery(SEARCH_USER_SQL+"'"+userID+"'");
	...
	private static final String CREATE_USERTYPE_SQL="INSERT INTO user_type(user_type,max_borrow,type_id) VALUES(?,?,?)";
